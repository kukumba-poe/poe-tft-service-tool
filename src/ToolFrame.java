...
public class ToolFrame extends JFrame implements ActionListener {
   ...
   public ToolFrame() {
    ...
    public void set_random_color(JLabel label) {
       int tint = 20 + (int)(Math.random() * ((70 - 20) + 1));
       int green = 100 + (int)(Math.random() * ((210 - 100) + 1));
       label.setForeground(new Color(tint, green, tint, 255));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if ("copy".equals(e.getActionCommand())) {
            ...
            info_label.setText("Message copied");
            set_random_color(info_label);

        } else if("save".equals(e.getActionCommand())) {
            DataManager.save_settings(this);
            info_label.setText("Saved Settings");
            set_random_color(info_label);
        }
    }
}